"""
Module 40: seeds the SB_CG_RG_P7 (Side Buffer, Cattle Guard & Rail Guard, WAP-7, 3-Phase, M4-HR
section) checksheet template.

Run once: `venv/bin/python scripts/seed_side_buffer_cattle_guard_p7_template.py`

Source: page 21 of the supplied WAP-7 checksheet - "Side Buffer" (6 activities per side buffer,
1 through 4) and "Cattle Guard / Rail Guard" (6 activities per cab, CAB-1/CAB-2) - identical
shape and standard values to the WAG9HC sheet.
"""
...
if __name__ == "__main__":
    run_seed(
        equipment_code="SB_CG_RG_P7", template_code="98", technology="3_PHASE",
        template_name="Checksheet for Side Buffer, Cattle Guard & Rail Guard (WAP-7)",
        description="Side Buffer, Cattle Guard & Rail Guard checksheet - WAP-7, 3-Phase - M4-HR section.",
        build_fn=build,
    )
