"""
Module 40: seeds the Axle BM_P7 (Axle Box Mounting, WAP-7, 3-Phase, M4-HR section) checksheet
template.

Run once: `venv/bin/python scripts/seed_axle_box_mounting_p7_template.py`

Source: pages 9-10 of the supplied WAP-7 checksheet - "Axle Box Mounting" (RDSO/SMI-246),
identical shape and standard values to the WAG9HC Axle Box Mounting sheet - implemented as its
own independent template since Axle BM_P7 is a separate equipment record.
"""
...
if __name__ == "__main__":
    run_seed(
        equipment_code="Axle BM_P7", template_code="87", technology="3_PHASE",
        template_name="Checksheet for Axle Box Mounting (WAP-7)",
        description="Axle Box Mounting checksheet - WAP-7, 3-Phase - M4-HR section.",
        build_fn=build,
    )
