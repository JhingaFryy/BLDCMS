"""
Module 40: seeds the PS_P7 (Piston Stroke, WAP-7, 3-Phase, M4-HR section) checksheet template.

Run once: `venv/bin/python scripts/seed_piston_stroke_p7_template.py`

Source: page 23 of the supplied WAP-7 checksheet - "Piston Stroke" (repeated once per wheel-pair
group: 1-3, 2-4, 3-5, 4-6, 7-9, 8-10, 9-11, 10-12) and "Centre Buffer Coupler, Side Buffer and
Rail Guard Height" (repeated once per cab, CAB-1/CAB-2) - identical shape and standard values to
the WAG9HC sheet; the piston stroke range is explicitly labelled "WAP-7: 107 to 117mm" on both
sheets.
"""
...
def build(add):
    piston_activities = [
        {"key": "piston_stroke", "label": "Piston Stroke", "field_type": "numeric_range", "required": True,
         ...
         "standard_value": "WAP-7: 107 to 117mm", "authority_reference": "RDSO/SMI-197"},
...
if __name__ == "__main__":
    run_seed(
        equipment_code="PS_P7", template_code="100", technology="3_PHASE",
        template_name="Checksheet for Piston Stroke (WAP-7)",
        description="Piston Stroke, Centre Buffer Coupler/Side Buffer/Rail Guard Height checksheet - "
                     "WAP-7, 3-Phase - M4-HR section.",
        build_fn=build,
    )
