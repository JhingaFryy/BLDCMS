"""
Module 40: seeds the GTTM_P7 (Green Testing of Traction Motor, WAP-7, 3-Phase, M4-HR section)
checksheet template.

Run once: `venv/bin/python scripts/seed_green_testing_tm_p7_template.py`

Source: page 24 of the supplied WAP-7 checksheet - "Green Testing of Traction Motor", one row per
traction motor run (SN 1-6), each recording a Before and an After (1 hour later) temperature
reading across ambient, axle box (PE/CE, each with an outer "C" and bearing "B" point), MSU
(PE/CE), TM (PE/CE) and gear case - identical structure to the WAG9HC sheet.
"""
...
if __name__ == "__main__":
    run_seed(
        equipment_code="GTTM_P7", template_code="101", technology="3_PHASE",
        template_name="Checksheet for Green Testing of Traction Motor (WAP-7)",
        description="Green Testing of Traction Motor checksheet - WAP-7, 3-Phase - M4-HR section.",
        build_fn=build,
    )
